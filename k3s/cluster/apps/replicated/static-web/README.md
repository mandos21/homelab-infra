...
Static Web is a small replicated service backed by Longhorn storage.
...
```bash
kubectl apply -f k3s/cluster/apps/replicated/static-web/migration/pod-copy-config.yaml
